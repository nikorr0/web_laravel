  ...
  <div class="body-container">
      ...
      <div class="cards-container">
                  ...
                  <div class="col">
                    <div class="card h-100 card-color">
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-text">{{ $short_texts[$i] }}</p>
                      </div>
                      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Modal{{ $names[$i] }}">
                              View
                      </button>
                    </div>
                  </div>
            ...
            <div class="modals-container">
              @for ($i = 0; $i < count($names); $i++)
                <div class="modal fade" id="Modal{{ $names[$i] }}" tabindex="-1" aria-labelledby="Modal{{ $names[$i] }}Label" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="Modal{{ $names[$i] }}Label">{{ $names[$i] }}</h5>
